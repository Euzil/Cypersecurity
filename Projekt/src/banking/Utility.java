...
public class Utility
{
    ...
    public static void printException(Exception ex)
    {
        ...
        if (LabEnvironment.DEBUG_FILE != null)
        {
            synchronized (LabEnvironment.DEBUG_FILE)
            {
                try
                {
                    LabEnvironment.DEBUG_FILE.write("E: Exception: " + ex.getMessage() + "\n");
                    for (StackTraceElement stackTraceElement : ex.getStackTrace())
                        LabEnvironment.DEBUG_FILE.write("E:   " + stackTraceElement.toString() + "\n");
                    LabEnvironment.DEBUG_FILE.flush();
    ...
    public static void sendPacket(DataOutputStream outputStream, String payload) throws IOException
    {
        ...
        // if you split this string afterward. Use the sendPacket(Stream, byte[]) overload for binary
        // data.
